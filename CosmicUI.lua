...
-- Constants
local WINDOW_SIZE = UDim2.new(0, 750, 0, 500)
local SIDEBAR_WIDTH = 200
local MINIMIZE_ICON_SIZE = UDim2.new(0, 50, 0, 50)

-- Theme Configuration
local Theme = {
    -- Main Colors (Space Theme)
    Background = Color3.fromRGB(13, 17, 23), -- Deep space
    Secondary = Color3.fromRGB(21, 32, 43), -- Darker space blue
    Accent = Color3.fromRGB(58, 96, 115), -- Cosmic teal
    AccentHover = Color3.fromRGB(73, 120, 142), -- Lighter cosmic teal
    AccentActive = Color3.fromRGB(88, 166, 255), -- Bright cosmic blue
    
    -- UI Colors
    Text = Color3.fromRGB(255, 255, 255), -- White text
    TextSecondary = Color3.fromRGB(161, 161, 170), -- Light gray
    TextDisabled = Color3.fromRGB(113, 113, 122), -- Disabled gray
    
    -- Component Colors
    Surface = Color3.fromRGB(30, 41, 59), -- Card background
    SurfaceHover = Color3.fromRGB(39, 53, 75), -- Hovered surface
    Button = Color3.fromRGB(51, 65, 85), -- Button background
    ButtonHover = Color3.fromRGB(71, 85, 105), -- Button hover
    Toggle = Color3.fromRGB(39, 39, 42), -- Toggle background
    ToggleActive = Color3.fromRGB(59, 130, 246), -- Active toggle (blue)
    
    -- Border Colors
    Border = Color3.fromRGB(39, 39, 42), -- Standard border
    BorderLight = Color3.fromRGB(63, 63, 70), -- Light border
    BorderAccent = Color3.fromRGB(59, 130, 246), -- Accent border
    ...
    WindowGradient = ColorSequence.new({
        ...
        ColorSequenceKeypoint.new(1, Color3.fromRGB(8, 14, 25))
    }),
...
local function CreatePadding(parent, padding)
    padding = padding or UDim.new(0, 12)
...
function CosmicUI:CreateWindow(config)
    ...
    CreateCorner(window.TitleBar, UDim.new(0, 12))
    ...
    CreateCorner(minimizeButton, UDim.new(0, 6))
    ...
    window.Sidebar.Size = UDim2.new(0, SIDEBAR_WIDTH, 1, -50)
    window.Sidebar.Position = UDim2.new(0, 0, 0, 50)
    ...
    CreatePadding(window.Sidebar, UDim.new(0, 15))
    CreateListLayout(window.Sidebar, Enum.FillDirection.Vertical, UDim.new(0, 8))
    
    -- Content Area
    window.Content = Instance.new("Frame")
    window.Content.Name = "Content"
    window.Content.Size = UDim2.new(1, -SIDEBAR_WIDTH, 1, -50)
    window.Content.Position = UDim2.new(0, SIDEBAR_WIDTH, 0, 50)
...
function Window:CreateTab(name, icon)
    ...
    CreatePadding(tabButton, UDim.new(0, 15))
    ...
    CreatePadding(tabFrame, UDim.new(0, 20))
    local layout = CreateListLayout(tabFrame, Enum.FillDirection.Vertical, UDim.new(0, 12))
    ...
    return {
        ...
        CreateButton = function(self, config)
            ...
            button.MouseButton1Click:Connect(function()
                ...
                -- Visual feedback
                CreateTween(button, {BackgroundColor3 = Theme.AccentActive}, AnimationSettings.Fast):Play()
            ...
            button.MouseEnter:Connect(function()
                CreateTween(button, {BackgroundColor3 = Theme.ButtonHover}):Play()
            end)
            
            button.MouseLeave:Connect(function()
                CreateTween(button, {BackgroundColor3 = Theme.Button}):Play()
            end)
        ...
        CreateToggle = function(self, config)
            ...
            CreatePadding(toggleFrame, UDim.new(0, 15))
            ...
            CreateCorner(toggleSwitch, UDim.new(0, 11))
            CreateStroke(toggleSwitch, Theme.Border)
            ...
            CreateCorner(toggleIndicator, UDim.new(0, 9))
            ...
            local function UpdateToggle(value, animate)
                ...
                if animate then
                    ...
                    toggleIndicator.Position = value and UDim2.new(0, 25, 0, 2) or UDim2.new(0, 2, 0, 2)
        ...
        CreateSlider = function(self, config)
            ...
            CreatePadding(sliderFrame, UDim.new(0, 15))
            ...
            sliderHandle.Position = UDim2.new(0.5, -8, 0, -5)
            sliderHandle.BackgroundColor3 = Theme.Text
            sliderHandle.BorderSizePixel = 0
            sliderHandle.Parent = sliderTrack
            
            CreateCorner(sliderHandle, UDim.new(0, 8))
            CreateStroke(sliderHandle, Theme.AccentActive, 2)
            ...
            local function UpdateSlider(value, updatePosition)
                ...
                if updatePosition then
                    ...
                    CreateTween(sliderHandle, {Position = UDim2.new(percentage, -8, 0, -5)}):Play()
                end
            ...
            sliderTrack.MouseEnter:Connect(function()
                CreateTween(sliderHandle, {Size = UDim2.new(0, 18, 0, 18)}):Play()
            end)
            
            sliderTrack.MouseLeave:Connect(function()
                if not dragging then
                    CreateTween(sliderHandle, {Size = UDim2.new(0, 16, 0, 16)}):Play()
                end
            end)
        ...
        CreateDropdown = function(self, config)
            ...
            CreatePadding(dropdownFrame, UDim.new(0, 15))
            ...
            dropdownButton.Text = config.CurrentOption or "Select Option"
            ...
            CreatePadding(dropdownButton, UDim.new(0, 10))
            ...
            CreateStroke(dropdownList, Theme.BorderAccent)
            CreateDropShadow(dropdownList, Vector2.new(0, 4), 12, 0.3)
            
            local listLayout = CreateListLayout(dropdownList, Enum.FillDirection.Vertical, UDim.new(0, 2))
            CreatePadding(dropdownList, UDim.new(0, 5))
            ...
            local function CreateOption(optionText)
                ...
                optionButton.MouseButton1Click:Connect(function()
                    ...
                    SafeCall(config.Callback or function() end, optionText)
                    
                    if flag and self.Window.Flags then
                        self.Window.Flags[flag] = {CurrentOption = optionText}
                    end
                ...
                optionButton.MouseEnter:Connect(function()
                    CreateTween(optionButton, {BackgroundColor3 = Theme.ButtonHover}):Play()
                end)
                
                optionButton.MouseLeave:Connect(function()
                    CreateTween(optionButton, {BackgroundColor3 = Theme.Button}):Play()
                end)
            end
            ...
            dropdownButton.MouseButton1Click:Connect(function()
                ...
                if isOpen then
                    ...
                    local targetSize = math.min(listLayout.AbsoluteContentSize.Y + 10, 150)
            ...
            dropdownButton.MouseEnter:Connect(function()
                CreateTween(dropdownButton, {BackgroundColor3 = Theme.ButtonHover}):Play()
            end)
            
            dropdownButton.MouseLeave:Connect(function()
                CreateTween(dropdownButton, {BackgroundColor3 = Theme.Button}):Play()
            end)
        ...
        CreateInput = function(self, config)
            ...
            CreateStroke(inputFrame, Theme.Border)
            CreatePadding(inputFrame, UDim.new(0, 15))
            ...
            CreateCorner(inputBox, UDim.new(0, 6))
            CreateStroke(inputBox, Theme.Border)
            CreatePadding(inputBox, UDim.new(0, 10))
            ...
            inputBox.Focused:Connect(function()
                CreateTween(inputBox, {BackgroundColor3 = Theme.ButtonHover}):Play()
                CreateStroke(inputBox, Theme.AccentActive, 1)
            end)
            
            inputBox.FocusLost:Connect(function()
                CreateTween(inputBox, {BackgroundColor3 = Theme.Button}):Play()
                CreateStroke(inputBox, Theme.Border, 1)
            end)
