...
function OGLib:CreateWindow(options)
    ...
    function Window:CreateTab(name)
        ...
        function Tab:CreateDropdown(options)
            ...
            -- Create dropdown container in ScreenGui for proper layering
            ...
            local function UpdateDropdownPosition()
                if DropdownContainer.Visible then
                    ...
                    DropdownContainer.Position = UDim2.new(0, buttonPos.X, 0, buttonPos.Y + buttonSize.Y + 5)
                    DropdownContainer.Size = UDim2.new(0, buttonSize.X, 0, math.min(#items * 25 + 8, 150))
        ...
        function Tab:CreateCopyButton(options)
            ...
            CopyButton.MouseEnter:Connect(function()
                CreateTween(CopyButton, {BackgroundColor3 = CurrentTheme.Primary}):Play()
            end)
            
            CopyButton.MouseLeave:Connect(function()
                CreateTween(CopyButton, {BackgroundColor3 = CurrentTheme.Secondary}):Play()
            end)
