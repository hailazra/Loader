...
function SpaceMangaLib:CreateWindow(config)
	...
	mainFrame.BackgroundTransparency = Colors.BackgroundTransparency -- Added transparency
	...
	-- Improved Minimize Icon (smaller)
	local minimizeIcon = Instance.new("TextButton")
	minimizeIcon.Name = "MinimizeIcon"
	minimizeIcon.BackgroundColor3 = Colors.AccentPrimary
	minimizeIcon.BorderSizePixel = 0
	minimizeIcon.Size = UDim2.new(0, 45, 0, 45) -- Reduced from 55
	...
	local function toggleMinimize()
		if Window.IsMinimized then
			...
			CreateTween(mainFrame, {Size = windowConfig.Size}, 0.25, Enum.EasingStyle.Back, Enum.EasingDirection.Out):Play()
			Window.IsMinimized = false
		else
			-- Minimize with smooth animation
			CreateTween(mainFrame, {Size = UDim2.new(0, 0, 0, 0)}, 0.25, Enum.EasingStyle.Back, Enum.EasingDirection.In).Completed:Connect(function()
				mainFrame.Visible = false
				minimizeIcon.Visible = true
			end)
			CreateTween(mainFrame, {Size = UDim2.new(0, 0, 0, 0)}, 0.25, Enum.EasingStyle.Back, Enum.EasingDirection.In):Play()
	...
	function Window:CreateTab(name, icon)
		...
		function Tab:CreateSection(name)
			...
			function Section:CreateDropdown(config)
				...
				dropdownList.Size = UDim2.new(0.55, 0, 0, #dropdownConfig.Options * 22)
