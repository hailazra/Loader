--[[
	Space Manga GUI Library - Improved Version 2.2
	Based on Rayfield Interface Suite
	
	New Features:
	- Dual Theme System (Space & Manga)
	- Slider Component
	- Dropdown Component with Scrollable Options
	- Notification System
	- Improved Animations
	...
	- Reverted Minimize to Icon functionality (from v1.0 working version)
	- Improved Padding and Element Alignment
]]
...
function SpaceMangaLib:CreateWindow(config)
	...
	-- Minimize Icon (reverted to original working version)
	local minimizeIcon = Instance.new("TextButton")
	minimizeIcon.Name = "MinimizeIcon"
	minimizeIcon.BackgroundColor3 = Colors.AccentPrimary
	minimizeIcon.BorderSizePixel = 0
	minimizeIcon.Size = UDim2.new(0, 55, 0, 55) -- Original size for better visibility
